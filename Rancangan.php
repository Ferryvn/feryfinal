        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data Dana Desa</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $data['sisa'] ?></td>
                                    <!-- Modal -->
                                    <td>
                                <a href="form_editr.php?id=<?php echo $data['id'] ?>" class="btn btn-sm btn-info"><i class="fa fa-solid fa-pen"></i></a>
                                ...
                                <div class="modal-footer">
                                  ...
                                  <a href="proses_hapusr.php?id=<?php echo $data['id'] ?>" class="btn btn-danger">Ya</a>
                                </div>
                              </div>
                              </div>
