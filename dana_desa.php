                ...
                <tr>
                  ...
                  <tbody>
                            ...
                            ?>
                                ...
                                <td>
                                <a href="form_editd.php?id=<?php echo $data['id'] ?>" class="btn btn-sm btn-info"><i class="fa fa-solid fa-pen"></i></a>
                                ...
                                <div class="modal-footer">
                                  ...
                                  <a href="proses_hapusd.php?id=<?php echo $data['id'] ?>" class="btn btn-danger">Ya</a>
                                </div>
                              </div>
                              </div>
